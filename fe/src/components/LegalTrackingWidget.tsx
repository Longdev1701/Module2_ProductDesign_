...
const defaultTrackingItems: LegalTrackingItem[] = [
  {
    ...
    status: 'MỚI NHẤT',
    statusType: 'primary',
    title: 'GACC: Cập nhật Nghị định thư Sầu riêng',
    description: 'Vừa cập nhật 2 giờ trước. Ảnh hưởng đến tiêu chuẩn đóng gói mã HS 0810.60.00.',
  ...
  },
  {
    ...
    status: 'CẢNH BÁO',
    statusType: 'error',
    title: 'Trung Quốc: Kiểm dịch thực vật mới',
    description: 'Quy định có hiệu lực trong 30 ngày tới. Cần cập nhật chứng từ GACC.',
  ...
  },
  {
    ...
    status: 'DỰ THẢO',
    statusType: 'neutral',
    title: 'AQSIQ: Quy định kiểm tra chất lượng 2025',
