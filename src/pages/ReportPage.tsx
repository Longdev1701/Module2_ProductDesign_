...
import { ArrowRight, CheckCircle2, ChevronRight, AlertTriangle, ExternalLink } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center text-xs font-mono text-outline uppercase tracking-wider mb-6">
        <Link to="/history" className="hover:text-primary transition-colors">LỊCH SỬ KIỂM TRA</Link>
